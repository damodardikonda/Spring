...
public class NewTest {
	...
	public void Test1() throws InterruptedException {
		...
		Thread.sleep(500);
		driver.findElement(By.name("email1")).sendKeys("mandy1gmail.com");
		Thread.sleep(500);
	...
	public void Test2() throws InterruptedException {
		...
		driver.findElement(By.name("email1")).sendKeys("mandy1@gmail.com");
		Thread.sleep(500);
		driver.findElement(By.name("pw1")).sendKeys("xyz1234");
		Thread.sleep(500);
		driver.findElement(By.name("pw2")).sendKeys("xyz1234");
	...
	public void Test3() throws InterruptedException {
		...
		driver.findElement(By.name("email2")).sendKeys("mandy1gmacom");
		Thread.sleep(500);
	...
	public void Test4() throws InterruptedException {
		...
		driver.findElement(By.name("email2")).sendKeys("mandy1@gmail.com");
		Thread.sleep(500);
	...
	public void Test5() throws InterruptedException {
		...
		Thread.sleep(500);
		driver.findElement(By.xpath("//*[@id=\"myTopnav\"]/a[2]")).click();
		driver.findElement(By.name("name1")).sendKeys("Kunal Bhalgat");
		Thread.sleep(500);
		driver.findElement(By.name("dob1")).sendKeys("02/22");
		Thread.sleep(500);
		driver.findElement(By.name("mail1")).sendKeys("kbhalgat@gmail.com");
		Thread.sleep(500);
	...
	public void Test9() throws InterruptedException {
	 ...
	 @Test(priority = 1, alwaysRun = true) 
	  public void Test10() throws InterruptedException {
			...
			Thread.sleep(1500);
			driver.findElement(By.xpath("//*[@id=\"send\"]/input[2]")).sendKeys("Kunal Pune");
			Thread.sleep(1500);
	  ...
	  public void Test11() throws InterruptedException { 
			...
			Thread.sleep(1500);
			driver.findElement(By.xpath("//*[@id=\"myTopnav\"]/a[3]")).click();
			driver.findElement(By.xpath("//*[@id=\"delete\"]/input[1]")).sendKeys("Pranav Kumar");
			Thread.sleep(1500);
	  ...
	  public void Test12() throws InterruptedException { 
			...
			Thread.sleep(1500);
			driver.findElement(By.xpath("//*[@id=\"myTopnav\"]/a[3]")).click();
			driver.findElement(By.xpath("//*[@id=\"delete\"]/input[1]")).sendKeys("Kunal Bhalgat");
			Thread.sleep(1500);
